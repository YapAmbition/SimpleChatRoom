...
import type { ScrMessage, ScrChannelConfig } from "../src/types.js";

// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------

function makeScrMsg(overrides: Partial<ScrMessage> = {}): ScrMessage {
  return {
...
describe("validateAccountConfig", () => {
  ...
  it("should throw on missing required fields", () => {
    assert.throws(
      () => validateAccountConfig({}, "test"),
      /serverUrl is required/
    );

    assert.throws(
      () => validateAccountConfig({ serverUrl: "http://x" }, "test"),
      /room is required/
    );
